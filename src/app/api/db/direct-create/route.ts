...
export async function POST() {
  try {
    ...
    try {
      ...
      // Try to create ai_configurations by inserting a record
      ...
      if (!aiError) {
        console.log('ai_configurations table created or already exists');
        tablesCreated = true;
      } else {
        console.error('Error creating ai_configurations table:', aiError);
      }
    } catch (error) {
